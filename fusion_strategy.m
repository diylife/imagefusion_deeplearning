function [gen, ave1, ave2,weight1,weight2] = fusion_strategy(features_a, features_b, source_a, source_b, unit)
...
subplot(221),mesh(weight_ave_temp1);
subplot(222),mesh(weight_ave_temp2)
gen = source_a.*weight_ave_temp1 + source_b.*weight_ave_temp2;
subplot(223),mesh(gen)
ave1 = ave_temp1;
ave2 = ave_temp2;
